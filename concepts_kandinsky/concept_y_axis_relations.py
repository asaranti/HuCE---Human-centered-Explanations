"""
    Concept for symmetric and non-symmetric y axis relations
...
# [0.] y-axis relation =================================================================================================
########################################################################################################################
def y_axis_relations(all_node_ids: list, nodes_shapes: list, nodes_colors: list,
                ...
                for node_idx in list(graph.nodes):
                    ...
                    for rest_node_idx in rest_of_nodes_indexes_list:
                        ...
                        if (node_idx, rest_node_idx) in graph_edges_list or \
                            ...
                            if nodes_with_noise_pos_dict[node_idx][1] < nodes_with_noise_pos_dict[rest_node_idx][1]:
                                sub_concept_str += f"down_of(object_{graph_idx_over_all}_{node_idx}, " \
                                                   f"object_{graph_idx_over_all}_{rest_node_idx}), " \
                                                   + new_line_or_not
                            elif nodes_with_noise_pos_dict[node_idx][1] > nodes_with_noise_pos_dict[rest_node_idx][1]:
                                sub_concept_str += f"up_of(object_{graph_idx_over_all}_{node_idx}, " \
                                                   f"object_{graph_idx_over_all}_{rest_node_idx}), " \
                                                   + new_line_or_not
...
graph_idx_over_all = 246

concept_name = "concept_y_axis_relations"
...
graph_idx_over_all, graphs_all_symmetric = y_axis_relations(
    all_node_ids,
    nodes_shapes,
    nodes_colors,
...
graph_idx_over_all, graphs_all_non_symmetric = y_axis_relations(
    all_node_ids,
    nodes_shapes,
    nodes_colors,
    nodes_with_noise_pos_dict,
...
with open(os.path.join(dataset_pytorch_folder, 'concept_y_axis_relations.pkl'), 'wb') as f:
