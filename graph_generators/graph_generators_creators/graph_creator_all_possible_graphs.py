...
from graph_generators.graph_generators_creators.graph_generator_all_possible_graphs import create_all_possible_graphs


def generator_all_possible_graphs_graph(kandinsky_pattern_name: str, class_name_0: str, class_name_1: str) -> tuple:
    """
    Graph generator
    ...
    for root, dirs, class_1_files in os.walk(kandisnky_class_1_path):
        for class_1_file in class_1_files:
            if 'content' in class_1_file and class_1_file.endswith('.csv'):
                ...
                graph_class_1_data_sample, positions_class_1_dict = create_all_possible_graphs(class_1_df,
    ...
    for root, dirs, class_0_files in os.walk(kandisnky_class_0_path):
        for class_0_file in class_0_files:
            if 'content' in class_0_file and class_0_file.endswith('.csv'):
                ...
                graph_class_0_data_sample, positions_class_0_dict = create_all_possible_graphs(class_0_df,
