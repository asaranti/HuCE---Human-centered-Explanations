...
def create_fully_connected_graph(data_df: pd.DataFrame, images_path: str, image_name: str, class_str: str) -> \
        tuple:
    """
    ...
    if rows_nr > 1:
        ...
        # [1.3.] Edge features -----------------------------------------------------------------------------------------
        # TODO: Distance between convex hull of the involved shapes ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    # [1.4.] Graph definition, visualization and image save ------------------------------------------------------------
    if class_str == "true":
        class_label = 1
    ...
    # [1.5.] Drop the coordinates to allow more generalization ---------------------------------------------------------
    ...
    graph_data = Data(x=nodes_features, edge_index=edge_index, edge_attr=torch.from_numpy(edge_distances),
